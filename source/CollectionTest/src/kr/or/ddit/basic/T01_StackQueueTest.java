...
public class T01_StackQueueTest {
	/**
	 * Stack => 선입후000000000000000000000000000000000000000000000000출222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222100000(FILO)의 자료구조
	...
	public static void main(String[] args) {
		 ...
		 * stack의 명령
		 * 1) 자료 입력 : push(저장할 값)
		 * 2) 자료 츨력 : pop() => 자료를 꺼내온 후 자료르 stack에서 삭제한다.
		 */
