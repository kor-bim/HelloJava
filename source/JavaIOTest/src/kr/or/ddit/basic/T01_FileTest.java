...
public class T01_FileTest {
	public static void main(String[] args) throws IOException {
		 ...
		 * File 객체 만들기 연습
		 * 
		 * 1. new File(String 파일 또는 경로명) => 디렉토리와 디렉토리 사이 또는 디렉토리의 파일명 사이의 구분문자는 '\'를
		 * 사용하거나 '/'를 사용할 수 있다.
		 */
		...
		/*
		 * 2. new File(File parent, String child) => 'parent' 디렉토리 안에 있는 'child'파일 또는
		 * 디렉토리를 갖는다.
		 */
		...
		System.out.println("상대 경로 : " + file4.getPath());
		 ...
		 * 디렉토리(폴더) 만들기
		 * 
		 * 1. mkdir() => File객체의 경로 중 마지막 위치의 디렉토리를 만든다. 중간의 경로가 모두 미리 만들어져 있어야 한다.<br>
		 * 2. mkdirs() => 중간의 경로가 없음 중간의 경로도 새롭게 만든 후 마지막 위치의 디렉토리를 만들어 준다.<br> 
		 * 위에 두 메서드 모두 만들기를 성공하면 true, 실패하면 false를 반환
		 */
