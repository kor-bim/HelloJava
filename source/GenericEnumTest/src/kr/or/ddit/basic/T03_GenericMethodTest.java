...
class Util {
	 ...
	 * 
	 * 파라미터 타입과 리턴타입으로 타입 파라미터를 가지는 메서드 선언방법 : 리턴타입 앞에 <> 기호를 추가하고 타입 파라미터를 기술 후
	 * 사용함.
	 * 
	 * @param p1
	 * @param p2
...
public class T03_GenericMethodTest {
	public static void main(String[] args) {
		...
		// Util.<Integer, String>compare
		boolean result1 = Util.compare(p1, p2); // 구체적 타입을 명시적으로 지정(생략가능)
