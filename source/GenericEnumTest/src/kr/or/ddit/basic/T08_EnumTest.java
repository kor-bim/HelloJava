 ...
 * 
 * 열거형 데이터를 선언하는 방법 enum 열거형 이름{ 상수값1, 상수값, ... ,상수값 n}
 */
public class T08_EnumTest {
	...
	public enum Season {
		봄("3월부터 5월까지"), 여름("6월 부터 8월까지"), 가을("9월부터 11월까지"), 겨울("12월 부터 2월까지");
	...
	public static void main(String[] args) {
		 ...
		 */
		City myCity1; // 열겨형 객체변수 선언
		City myCity2;
		// 열거형 객체변수에 값 저장하기
		myCity2 = City.서울;
		myCity1 = City.valueOf("서울"); // City Enum 에서 '서울' 데이터 가져옴
