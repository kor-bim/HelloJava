...
public class BoardMain {
	...
	private void getSearchBoard() {
		...
		System.out.print("작성 날짜 (YYYY-MM-DD) >> ");
		...
		for (BoardVO bv2 : boardList) {
			System.out.println("──────────────────────────────────────────");
			System.out.println("글 번호" + bv2.getBoard_no());
			System.out.println("글 제목: " + bv2.getBoard_title());
			System.out.println("작성일자: " + bv2.getBoard_date());
			System.out.println("작성자: " + bv2.getBoard_writer());
			System.out.println("글 내용: " + bv2.getBoard_content());
			System.out.println("──────────────────────────────────────────");
		}
		System.out.println("──────────────────────────────────────────────────────────────────");
	...
	private void displayBoardAll() {
		...
		for (BoardVO bv : boardList) {
			System.out.print("글 번호: " + bv.getBoard_no() + "\t");
			System.out.println("글 제목: " + bv.getBoard_title() + "\t");
		...
		int BoardNo = boardList.get(choice - 1).getBoard_no();
		List<BoardVO> selectList = service.selectBoard(BoardNo);

		for (BoardVO bv : selectList) {
			System.out.println("──────────────────────────────────────────");
			System.out.println("글 번호: " + bv.getBoard_no());
			System.out.println("글 제목: " + bv.getBoard_title());
			System.out.println("작성일자: " + bv.getBoard_date());
			System.out.println("작성자: " + bv.getBoard_writer());
			System.out.println("글 내용: " + bv.getBoard_content());
			System.out.println("──────────────────────────────────────────");
