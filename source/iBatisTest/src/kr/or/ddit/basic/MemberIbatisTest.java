...
//		// Ibatis를 이용하여 DB자료를 처리하는 직업 순서
//		// 1. ibatis의 환결설정파일(xml)을 읽어와 실행시킨다.
//		try {
//			// 1-1. xml문서 읽어오기
...
//			mv.setMem_id("a001");
//			mv.setMem_name("강감찬");
//			mv.setMem_tel("010-1234-5678");
//			mv.setMem_addr("대전광역시 중구 대흥동");
//
//			// 2) SqlMapClient객체 변수를 이용하여 해당 쿼리문을 실행한다.
//			// 형식)smc.insert("namespace값.id값", 파라미터객체); 반환값: 성공하면 null이 반환된다.
...
//			mv2.setMem_id("a001");
//			mv2.setMem_name("이순신");
//			mv2.setMem_tel("010-8521-5678");
//			mv2.setMem_addr("서울특별시 강남");
//
//			// update()메소드의 반환값은 성공한 레코드 수 이다.
...
//			// 2-4. select 작업
//			// 1) 응답의 결과가 여러개 인 경우
//			// System.out.println("select 작업(결과가 여러개인 경우) 시작..");
//			//
//			// // 응답 결과가 여러개 일 경우에는 queryForList메서드를 이용한다.
//			// // 이 메서드는 여러개의 레코드를 VO에 담은 후 VO데이터를 List에 추가해주는 작업을 자동으로 수행한다.
...
//
//			// 2) 응답이 1개인 경우
//			System.out.println("select 작업(결과가 1개인 경우) 시작..");
//			// 응답 결과가 1개가 확실할 경우에는 queryForObject메서드를 사용한다.
//
//			MemberVO mv4 = (MemberVO) smc.queryForObject("memberTest.getMember", "c001");
